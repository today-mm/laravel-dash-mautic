...
{{$laravelDashPackageName->mautic->campaigns()}}
{{$laravelDashPackageName->mautic->campaign()}}
{{$laravelDashPackageName->mautic->segments()}}
{{$laravelDashPackageName->mautic->segment()}}
{{$laravelDashPackageName->mautic->contacts()}}
{{$laravelDashPackageName->mautic->contact()}}
